...
@section('pageTitle', 'Edit NCR')
@section('pageName', 'Edit NCR')
@section('css')
        ...
        <div class="col-sm-8 offset-sm-2">
            ...
            <div>
                @if ($errors->any())
                    ...
                    <br/>
                @endif
                <form method="post" action="{{ route('ncr.update', $audit->id) }}">
                    @method('PATCH')
                    @csrf
                    ...
                    <div class="row" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">
                        <div class="col-sm-8 offset-sm-2">
                            ...
                            <div>
                                ...
                                @endif
                                <form method="post" id="mocForm" action="{{ route('ncr.store') }}"
                                    ...
                                    <div class="form-group m-1">
                                        ...
                                        <label for="auditor_user_id">Category</label>
                                        <select style="width:100%;" class="form-control" name="category">

                                            @foreach($categories as $category)
                                                <option
                                                    {{($audit->category == $category ? "selected" : "")}} value="{{$category}}">{{$category}}</option>
                                            @endforeach
                                        </select>
                                    </div>
...
{{--                                    <input type="hidden" value="XDEBUG_TRIGGER=1">--}}
