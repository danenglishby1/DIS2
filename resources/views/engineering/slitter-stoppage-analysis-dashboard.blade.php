...
@section('dateRangePickerOnApplyCallback')
    ...
    */
    $.ajax({
    type: "POST",
    data: {'dtFrom': dtFrom, 'dtTo': dtTo, 'machineNo' : 50},
    ...
    @section('functionalScripts')
        ...
        <script>
            ...
            $('#content').delegate("a.exportStoppageDataLink", "click", function (e) {
                ...
                window.location.href = rootUrl + "/api/exportHrStopfWeldMillStoppageData?dtFrom=" + dtFrom + "&dtTo=" + dtTo + "&stopType=" + stopType + "&stopArea=" + stopAreaCode + "&stopReason=" + stopReason + "&machineNo=50";
