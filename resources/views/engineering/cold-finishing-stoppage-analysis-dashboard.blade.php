...
@section('pageTitle', 'CF Stoppage Analysis Dashboard')
@section('pageName', 'CF Stoppage Analysis Dashboard')
...
@section('dateRangePickerOnApplyCallback')
    $.ajax({
    type: "POST",
    data: {'dtFrom': dtFrom, 'dtTo': dtTo, 'machineNo' : 200},
...
<div style="text-align: center;
    margin-top: -50px;">
    <h2>Cold Finishing Mill (Hydro) Availability</h2>
</div>
...
<div class="modal fade" id="notificationModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    @section('functionalScripts')
        ...
        <script src="{{ asset('public/js/engineering-stoppage-analysis/listeners.js?v=1.2')}}"></script>
        ...
        <script>
            ...
            $('#content').delegate("a.exportStoppageDataLink", "click", function (e) {
                ...
                window.location.href = rootUrl + "/api/exportStopfStoppageDataByMachineNo?dtFrom=" + dtFrom + "&dtTo=" + dtTo + "&stopType=" + stopType + "&stopArea=" + stopAreaCode + "&stopReason=" + stopReason + "&machineNo=200";
