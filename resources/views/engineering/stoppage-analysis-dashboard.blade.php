...
@section('pageTitle', 'Stoppage Analysis Dashboard')
@section('pageName', 'Stoppage Analysis Dashboard')
...
@section('dateRangePickerOnApplyCallback')
    ...
    */
    $.ajax({
    type: "POST",
    data: {'dtFrom': dtFrom, 'dtTo': dtTo, 'machineNo' : 100},
...
<div style="text-align: center; margin-top: -50px;">
    <h2>Weld Mill Availability</h2>
</div>


<div class="filters" style="justify-content: normal;">
    @include('layouts.templates.daterangepicker')
    <a class='exportStoppageDataLink' href='#' style="margin-left: 10px; margin-top: 6px;">Export CSV (Date Level & ALL Types)</a>

    <span id="weldMillStatus"
          style="display: none; position: absolute; padding: 5px; right: 25px;top: 128px; font-size: 26px; color: yellow; background: red;border-radius: 3px;">
...
<div class="dashboardContainer" style="display: flex;">
    ...
    <div class="chartsContainer" style="flex:3; margin: 0px 30px 30px 30px">
        ...
        <div class="EMPTitle" style="background: #e9e9e9;padding: 0.5em;flex:3; margin:1em;text-align: center;">Unplanned Stops & Minutes (E,M & P)</div> <div style="background: #e9e9e9; padding: 0.5em;flex: 2; margin: 1em;text-align: center;" class="CZTitle">Planned Stops & Minutes (C & Z)</div>
        </div>
        <h5>Stop Types</h5>
    ...
    @section('functionalScripts')
        ...
        <script>
            ...
            $('#content').delegate("a.exportStoppageDataLink", "click", function (e) {
                ...
                console.log(stopAreaCode);
                console.log(stopReason);
                console.log(window.dtFrom);

                window.location.href = rootUrl + "/api/exportHrStopfWeldMillStoppageData?dtFrom=" + dtFrom + "&dtTo=" + dtTo + "&stopType=" + stopType + "&stopArea=" + stopAreaCode + "&stopReason=" + stopReason+ "&machineNo=100";
            ...
            setInterval(GetWeldMillActiveStatus, 90000);
