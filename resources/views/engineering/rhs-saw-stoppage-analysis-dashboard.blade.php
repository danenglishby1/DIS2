...
@section('pageTitle', 'RHS SAW Stoppage Analysis Dashboard')
@section('pageName', 'RHS SAW Stoppage Analysis Dashboard')
...
@section('dateRangePickerOnApplyCallback')
    ...
    */
    $.ajax({
    type: "POST",
    data: {'dtFrom': dtFrom, 'dtTo': dtTo, 'machineNo' : 302},
...
<div class="modal fade" id="notificationModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    @section('functionalScripts')
        ...
        <script src="{{ asset('public/libraries/NVD3/nv.d3.js?v=1.26')}}"></script>
        <script src="{{ asset('public/js/engineering-stoppage-analysis/functions.js?v=1.31')}}"></script>
        ...
        <script>
            ...
            $('#content').delegate("a.exportStoppageDataLink", "click", function (e) {
                ...
                window.location.href = rootUrl + "/api/exportStopfStoppageDataByMachineNo?dtFrom=" + dtFrom + "&dtTo=" + dtTo + "&stopType=" + stopType + "&stopArea=" + stopAreaCode + "&stopReason=" + stopReason + "&machineNo=302";
