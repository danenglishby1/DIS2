...
@section('pageTitle', 'RHS Stoppage Analysis Dashboard')
@section('pageName', 'RHS Stoppage Analysis Dashboard')
...
@section('dateRangePickerOnApplyCallback')
    ...
    */
    $.ajax({
    type: "POST",
    data: {'dtFrom': dtFrom, 'dtTo': dtTo, 'machineNo' : 300},
...
<div style="text-align: center;
    margin-top: -50px;">
    <h2>RHS Mill (Furnace) Availability</h2>
</div>
    ...
    @section('functionalScripts')
        ...
        <script>
            ...
            $('#content').delegate("a.exportStoppageDataLink", "click", function (e) {
                ...
                window.location.href = rootUrl + "/api/exportStopfStoppageDataByMachineNo?dtFrom=" + dtFrom + "&dtTo=" + dtTo + "&stopType=" + stopType + "&stopArea=" + stopAreaCode + "&stopReason=" + stopReason + "&machineNo=300";
