...
@section('pageTitle', 'Shift Eng Logs')
@section('pageName', 'Shift Eng Logs')
...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <a href="{{ route('shift-eng-log.create')}}" class="btn btn-primary mb-2">Create New</a>
                ...
                <div class="col-sm-12">
                    <div id="doublescroll">
                        <table id="macro-table" class="table table-striped">
                            ...
                            @foreach($shiftEngLogs as $shiftLog)

                                <tr>
                                    <td>{{$shiftLog->id}}</td>
                                    <td>{{$shiftLog->shift}}</td>
                                    <td>{{$shiftLog->created_at}}</td>
                                    <td>
                                        <div style="display: flex;">
                                            <a href="{{ route('shift-eng-log.show',$shiftLog->id)}}"
                                               class="btn btn-primary m-1">View</a>

                                            <a href="{{ route('shift-eng-log.edit',$shiftLog->id)}}"
                                               class="btn btn-warning m-1">Edit</a>


                                            <form method="post" class="delete-form"
                                                  action="{{ route('shift-eng-log.destroy', $shiftLog->id)}}">
                                                @csrf
                                                @method('DELETE')
