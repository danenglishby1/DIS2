...
echo "<td style='padding:3px;border: 1px solid #ccc;'>" . $audit["id"] . "</td>" .
    ...
    "<td style='padding:3px;border: 1px solid #ccc;'>" . $audit["category"] . "</td>" .
