...
@section('pageTitle', 'Gauge Change')
@section('pageName', 'All Gauge Changes')
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display: flex;">
                                <a href="{{ route('wm-gauge-change.show',$gaugeChange->id)}}"
                                   class="btn btn-primary m-1">View</a>

                                <a href="{{ route('wm-gauge-change.edit',$gaugeChange->id)}}"
