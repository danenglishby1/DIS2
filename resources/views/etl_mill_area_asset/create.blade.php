    ...
    <div class="row" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">
        <div class="col-sm-8 offset-sm-2">
            ...
            <div>
                ...
                @endif
                <form method="post" action="{{ route('etl_mill_area_asset.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="">
                        ...
                        <div class="form-group m-1">
                            <label for="etl_area_id">Asset.</label>
                            <select class="form-control" name="etl_asset_id">
                                @foreach($etlAssets as $etlAsset)
                                    <option value="{{$etlAsset->id}}">{{$etlAsset->name}}</option>
                                @endforeach
