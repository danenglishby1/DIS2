...
@section('dateRangePickerOnApplyCallback')
    ...
    url: rootUrl+'/api/GetRHSQuenchData',
    dataType: 'json',
    ...
    <div class="fl1-500">
        <div class="card shadow mb-4">
            ...
            <div
                ...
                <h6 class="m-0 font-weight-bold text-primary">Quench Machine - All Series - Last 100 Sections In Date Range</h6>
            </div>
            <!-- Visual Content -->
            <!-- Card Body -->
            <div class="card-body">
...
@section('functionalScripts')
    ...
    <script>
        ...
        var arrLabels1 = [];
        var arrLabels2 = [];
        var liveApiFeedUrl = rootUrl + '/api/GetRHSQuenchData';
