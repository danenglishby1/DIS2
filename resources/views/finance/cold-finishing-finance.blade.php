...
@section('pageTitle', 'Cold Finishing Finance')
@section('pageName', 'Cold Finishing Finance')
    ...
    <div class="simpleflex justify-content-center">
        <div class="btn-flex mt-2 text-center">
            ...
            @section('dateRangePickerOnApplyCallback')
                ...
                window.location.href = rootUrl + "/finance/cold-finishing-finance?dtFrom="+dtFrom+"&dtTo="+dtTo;
