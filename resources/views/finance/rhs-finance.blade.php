...
@section('pageTitle', 'RHS Finance')
@section('pageName', 'RHS Finance')
    ...
    <div class="simpleflex justify-content-center">
        <div class="btn-flex mt-2 text-center">
            ...
            @section('dateRangePickerOnApplyCallback')
                ...
                window.location.href = rootUrl + "/finance/rhs-finance?dtFrom="+dtFrom+"&dtTo="+dtTo;
        ...
        <table class="table" id="financialTable">
            ...
            @foreach($stoppagesByMonthWeek as $key => $value)
                ...
                <tr>
                    ...
                    <td style="background: antiquewhite"
                        class="activityVarianceHours">{{ round( ($activtySTD - $value["items"]["Activity"]["hoursStopped"]),2)}}</td>
                    <!-- Activity hrs  -->
                    ...
                    <td style="background: antiquewhite"
                        class="stopVarianceHours">{{ round(($stopsStd - $totalStopsExclActivity),2)}}</td>
                    <!-- Stop Variance hrs  -->
                    <td style="background: antiquewhite" class="stopVarianceCost">
                        {{round( ($stopsStd - $totalStopsExclActivity)* $standardsArray["standardCost"],2)}}</td>
                    <!-- Stop Variance £  -->
