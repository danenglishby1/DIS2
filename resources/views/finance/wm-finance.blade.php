...
@section('pageTitle', 'WM Finance')
@section('pageName', 'WM Finance')
...
@endif
        ...
        <table class="table" id="financialTable">
            ...
            @foreach($stoppagesByMonthWeek as $key => $value)
                @php
                    ...
                    $stopsStd = (80 - (isset($value["items"]["Activity"]["hoursStopped"]) ? $value["items"]["Activity"]["hoursStopped"] : 0)) * $standardsArray["allowableStopsStandard"]; // uses hours
                    ...
                    $actualActivityHours = (isset($value["items"]["Activity"]["hoursStopped"]) ? $value["items"]["Activity"]["hoursStopped"] : 0);
                @endphp
                <tr>
                    ...
                    <td class="activityStopHours">{{$value["items"]["Activity"]["hoursStopped"]}}</td>
                    <!-- Activity Stops -->
                    <td class="totalStopsInclActivityHours">{{$totalStopTimeInclActivity}}</td>
                    <!-- Total Stops Including Activity -->
                    <td class="changingStopHours">{{$value["items"]["Changing"]["hoursStopped"]}}</td>
                    <!-- Changing Stops -->
                    ...
                    <td style="background: #ffda97" class="stdWorkedTimeHours">{{80 - $actualActivityHours}}</td>
                    <!-- STD WK Time -->
                    ...
                    <td style="background: #ffda97"
                        class="standardProductionTimeHours">{{(80 - $actualActivityHours) * $standardsArray["availabilityStandard"] }}</td>
                    <!-- STD Production Time -->
                    <td style="background: #ffda97"
                        class="productionStandardHours">{{(80 - $actualActivityHours) * $standardsArray["productionStandard"]}}</td>
                    <!-- Prod Standard -->
                    <td style="background: #ffda97"
                        class="changeoverStandardHours">{{(80 - $actualActivityHours) * $standardsArray["changeoverStandard"]}}</td>
                    <!-- Changeover Standard -->
                    <td style="background: #ffda97"
                        class="engChangeOverStandardHours">{{(80 - $actualActivityHours) * $standardsArray["engStandard"]}}</td>
                    <!-- Eng c/o Standard -->
                    ...
                    <td style="background: antiquewhite" class="activityVarianceHoursCost">
                        ...
                        {{round( ($activtySTD - $value["items"]["Activity"]["hoursStopped"])  * $standardsArray["standardCost"] ,2) }}</td>
                    ...
                    <td style="background: antiquewhite" style="background: #ffda97"
                        class="changeoverImpactVarianceHours">{{round(((80 - $actualActivityHours) * $standardsArray["changeoverStandard"] - (isset($value["items"]["Changing"]["hoursStopped"]) ? $value["items"]["Changing"]["hoursStopped"] : 0)),2)}}</td>
                    <!-- Changeover impact Variance hrs  -->
                    <td style="background: antiquewhite" style="background: #ffda97"
                        class="changeoverImpactVarianceCost">
                        {{round(((80 - $actualActivityHours) * $standardsArray["changeoverStandard"] - (isset($value["items"]["Changing"]["hoursStopped"]) ? $value["items"]["Changing"]["hoursStopped"] : 0)) * $standardsArray["standardCost"],2) }}</td>
            ...
            <tr>
                ...
                <td style="background: antiquewhite" class="activityVarianceMannedHours">0</td> <!-- ActivManned hrs  -->
    ...
    <button onclick="parseDataTable()">Parse Table For Exporting</button>
...
@section('functionalScripts')
    ...
    function parseDataTable() {
                var financeTable = $('#financialTable').DataTable({
                dom: 'Bfrtip',
                buttons: [
                    {
                        extend: 'excel',
