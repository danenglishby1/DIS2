...
@endif
    ...
    <div class="text-center">
        <h3>P & O Delivery Performance Dashboard - Booked </h3>
    </div>
        ...
        <div class="fl4">
            <div class="card shadow pb-2">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Booked Loads Not Collected by Month</h6>

                </div>
                <!-- Visual Content -->
                <!-- Card Body -->
                <div class="card-body">
                    <div id="bookedLoadsNotDeliveredByMonthBarChart" style="height:500px">
                        <svg></svg>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow pb-2">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">All Loads by Delivery Date</h6>
            ...
            <div class="card shadow pb-2">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Loads released for collection and past original requested date</h6>

                </div>
                <!-- Visual Content -->
                <!-- Card Body -->
                <div class="card-body">
                    <div id="outstandingLoadsReleasedPastOriginalReqestDateMultiBarChart" style="height:500px">
                        <svg></svg>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                type: 'POST',
                dataType: 'json',
                url: rootUrl + '/api/getBookedDashboardData',
                success: function (data) {
                    console.log(data);
                   // buildCustomerSelectList($.parseJSON(data.customerList));

                  //  buildCustomerSelectList(data.customerList);
                    RenderStaticDiscreteBarChart([$.parseJSON(data.bookedLoadsNotDeliveredByMonthJson)], 'label', 'value', 'bookedLoadsNotDeliveredByMonthBarChart', null, 'Month', 'Count', ',01f', ',01f', [], true, false, null, null, null, null, null, 45, {
                        top: 30,
                        right: 60,
                        bottom: 150,
                        left: 70
                    ...
                    nv.addGraph(function () {
                        ...
                        d3.select('#outstandingLoadsCollectedDeliveryTodayMultiBarChart svg')
                            .datum($.parseJSON(data.bookedLoadsNotDeliveredByRefDateJson))
                    ...
                    nv.addGraph(function () {
                        ...
                        d3.select('#outstandingLoadsReleasedPastOriginalReqestDateMultiBarChart svg')
                            .datum($.parseJSON(data.bookedLoadsNotCollectedPastOriginalCollectDateJson))
                            .transition().duration(500).call(chart);
