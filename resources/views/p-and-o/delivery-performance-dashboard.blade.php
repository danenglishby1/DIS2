...
@endif
    ...
    <div class="text-center">
        <h3>P & O Delivery Performance Booked</h3>
    </div>
        ...
        <div class="fl4">
            <div class="card shadow pb-2">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Outstanding Loads Collected not Delivered (Beyond planned delivery date)</h6>
                </div>
                <!-- Visual Content -->
                <!-- Card Body -->
                <div class="card-body">
