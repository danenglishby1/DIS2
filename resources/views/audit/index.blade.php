...
@section('pageTitle', 'Audits')
@section('pageName', 'Audits')
...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <a href="{{ route('audit.create')}}" class="btn btn-primary mb-2">Create New</a>
                                    ...
                                    <td>
                                        <div style="display: flex;">
                                            ...
                                            <a class="btn btn-success m-1"
                                               href="{{route('audit-files.create').'?id='.$audit->id}}">Manage Files</a>

                                            <form method="post" class="delete-form"
                                                  action="{{ route('audit.destroy', $audit->id)}}">
                                                @csrf
                                                @method('DELETE')
