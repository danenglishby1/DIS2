...
@section('pageTitle', 'Stock Tracking')
@section('pageName', 'Stock Tracking')
...
@section('functionalScripts')
    ...
    <script>
        ...
        var pivotData = <?php echo $stockTrackingData; ?>;
        ...
        RefreshPivotData('/api/GetStockTrackingPivotData', 300000);
        RefreshPivotWithDateCriteria("/api/GetStockTrackingPivotData");
