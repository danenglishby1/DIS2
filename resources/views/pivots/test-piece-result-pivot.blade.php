@extends('layouts.app')
    ...
    @section('pageTitle', 'Test Piece Result Pivot')
@section('pageName', 'Test Piece Result Pivot')
...
@section('functionalScripts')
    ...
    <script>
        ...
        var dataTableLayoutObj = [
            ...
            {title: "TP TYPE CODE", data: "TP_TYPE_CODE"},
            {title: "TP VARIABLE", data: "TP_VARIABLE"},
            {title: "ACTUAL RESULT 1", data: "ACTUAL_RESULT_1"},
            {title: "ACTUAL RESULT 2", data: "ACTUAL_RESULT_2"},
            {title: "ACTUAL RESULT 3", data: "ACTUAL_RESULT_3"},
            {title: "ACTUAL RESULT 4", data: "ACTUAL_RESULT_4"},
            {title: "ACTUAL RESULT 5", data: "ACTUAL_RESULT_5"},
            {title: "ACTUAL RESULT 6", data: "ACTUAL_RESULT_6"},
            {title: "ACTUAL RESULT 7", data: "ACTUAL_RESULT_7"},
            {title: "DATETIME RECEIVED", data: "DATETIME_RECEIVED"},
            {title: "TEST HOUSE RECEIVED", data: "LIMS_RESPONSE_DATETIME"},
            {title: "DAYS TO PROCESS", data: "DAYS_TO_PROCESS"},
        ...
        function UpdatePivotWithDateRange(dtFrom, dtTo) {
            ...
            $.ajax({
                type: "POST",
                url: rootUrl + '/api/GetTestPieceResultPivotData',
