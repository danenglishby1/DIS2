...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <a href="{{ route('etl_area.create')}}" class="btn btn-primary mb-2">Create New</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display: flex;">
                                ...
                                <a href="{{ route('etl_area.show',$etlArea->id)}}" class="btn btn-primary m-1">View</a>
{{--                                $userId == R.Butler || $userId == LABS || $userId == D.E--}}
{{--                                @if($userId == 47 || $userId == 56 || $userId == 4)--}}
                                <a href="{{ route('etl_area.edit',$etlArea->id)}}" class="btn btn-warning m-1">Edit</a>

                                <form method="post" class="delete-form"
                                      action="{{ route('etl_area.destroy', $etlArea->id)}}">
                                    @csrf
                                    @method('DELETE')
...
<script>
            ...
            tablesRows += "<tr>" +
                ...
                "<td>" +
                "  <div style='display: flex;'>" +
                "  <a href='"+rootUrl+"/etl_area/"+data[key].id+"' class='btn btn-primary m-1'>View</a>" +
                "  <a href='"+rootUrl+"/etl_area/"+data[key].id+"/edit' class='btn btn-warning m-1'>Edit</a>" +
                "<form method='post' class='delete-form' action='"+rootUrl+"/etl_area/"+data[key].id+"'>" +
