...
@section('pageTitle', 'Weld Head Dashboard')
@section('pageName', 'Weld Head Dashboard')
    ...
    <div class="fl1-500">
        <div class="card shadow mb-4">
            ...
            <div
                ...
                <h6 class="m-0 font-weight-bold text-primary">Weld Head - All Series (Segmented)</h6>
            </div>
            <!-- Visual Content -->
            <!-- Card Body -->
            <div class="card-body">
...
<div class="simpleflex">
    <div class="fl1-500">
        <div class="card shadow mb-4">
            ...
            <div
                class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Weld Head - Speed (Segmented)</h6>
            </div>
            <!-- Visual Content -->
            <!-- Card Body -->
            <div class="card-body">
                <div id="weldHeadSpeedLineChart" style="height: 225px;"
                     class='with-3d-shadow with-transitions'>
                    <svg></svg>
                </div>
            </div>
...
<div class="simpleflex">
    <div class="fl1-500">
        <div class="card shadow mb-4">
            ...
            <div
                class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Weld Head - Ircon & Weld Temp (Segmented)</h6>
            </div>
            <!-- Visual Content -->
            <!-- Card Body -->
            <div class="card-body">
                <div id="weldHeadTempsLineChart" style="height: 225px;"
                     class='with-3d-shadow with-transitions'>
                    <svg></svg>
                </div>
            </div>
...
<div class="simpleflex">
    <div class="fl1-500">
        <div class="card shadow mb-4">
            ...
            <div
                class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Weld Head - Control Sig & Power (Segmented)</h6>
            </div>
            <!-- Visual Content -->
            <!-- Card Body -->
            <div class="card-body">
                <div id="weldHeadSigPowerLineChart" style="height: 225px;"
                     class='with-3d-shadow with-transitions'>
                    <svg></svg>
                </div>
            </div>
...
<div class="simpleflex">
    <div class="fl1-500">
        <div class="card shadow mb-4">
            ...
            <div
                class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Weld Head All Series (Raw Data)</h6>
            </div>
            <!-- Visual Content -->
            <!-- Card Body -->
            <div class="card-body">
...
@section('functionalScripts')
    ...
    <script>
        ...
        var arrLabels1 = [];
        var arrLabels2 = [];
        var liveApiFeedUrl = rootUrl + '/api/GetWeldHeadDashboardAveragesAsNVD3Json';
        ...
        function BuildDyGraphLineChart(data) {
            ...
            for (let i = 0; i < data.pipeTransactionsArray.length; i++) {
                annotations.push({
                    series: "SPEED",
                    x: data.pipeTransactionsArray[i].DATETIME_TANDEM,
                    shortText: data.pipeTransactionsArray[i].PIPE_NO,
                    text: data.pipeTransactionsArray[i].PIPE_NO,
                    tickHeight: 15,
                    tickColor: 'purple',
                    tickWidth: 1,
                    width: 30,
        ...
        $('#exportDataBtn').click(function () {
            ...
            if ($('#coilNoRangeStart').val() !== '') {
                ...
                console.log("sending");
                console.log("sending");
                window.location.href = rootUrl + "/api/GetWeldHeadCSV?coilNoStart=" + $('#coilNoRangeStart').val() + "&coilNoEnd=" + $('#coilNoRangeEnd').val();
